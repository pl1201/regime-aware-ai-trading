...
class MultiTimeframeFeatureGenerator:
    ...
    def resample_to_timeframe(
        ...
        """
        Resample data sang khung thời gian mong muốn
    ...
    def _add_ict_fibo_features(self, df_tf: pd.DataFrame, tf: str) -> pd.DataFrame:
        ...
        ob_raw = detect_order_blocks(df_tf)
        ...
        fib_df = fib_features(df_tf)

        # Numeric confluence helpers cho downstream filter/model.
