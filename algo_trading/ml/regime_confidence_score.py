...
class RegimeConfidenceScorer:
    """
    Tính toán confidence score cho regime predictions

    Confidence score dựa trên:
    - Entropy của probability distribution (thấp = confident)
    - Distance từ uniform distribution (cao = confident)
    - Regime stability (ít thay đổi = confident)
    """
